...
class TwitterStore extends ReduceStore {
  ...
  get () {
    return {
      ...
      twitter_id: this.getState().twitter_id || 0,
      ...
      twitter_profile_banner_url_https: this.getState().twitter_profile_banner_url_https || '',
    ...
    switch (action.type) {
      ...
      case 'twitterIdentityRetrieve':
        ...
        return {
          ...
          twitter_profile_banner_url_https: action.res.twitter_profile_banner_url_https,
